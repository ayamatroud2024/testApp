    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Add Task') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{  __('Add Task') }} </a></li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                <h4 class="heading mb-0"> {{ __('Add Task') }}</h4>
                            ...
                            <form method="POST" action="{{ route('admin.tasks.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        <label for="ckeditor" class="form-label">Title<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="exampleFormControlInputfirst" name="title" value="{{ old('title') }}">
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInputfirst" name="description" value="{{ old('description') }}">
